...
// Quitar /backend/ si existe al final, para que apunte a la raíz del proyecto si se desea, 
// o dejarlo si el backend vive en su propia subcarpeta. 
// Para este proyecto, el backend vive en /backend, así que esta lógica funciona.
